...
async function setup (containerId, id, name, partitionKey){
  // prior cancellation to avoid dirty cases
  await deleteDocument(containerId, id, partitionKey);
...
module.exports = {
  getDocumentById, createDocument, deleteDocument, setup
}
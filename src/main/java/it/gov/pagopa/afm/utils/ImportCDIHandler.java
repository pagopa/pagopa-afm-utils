...
public class ImportCDIHandler extends FunctionInvoker<CDIWrapper, List<BundleResponse>> {
	...
	public /*@CosmosDBTrigger*/ /*List<BundleResponse>*/ 
			...
			*/
			// remove @HttpTrigger and @CosmosDBInput when @CosmosDBTrigger works for java function Extension 4.x+
			// (see: https://learn.microsoft.com/en-us/azure/azure-functions/functions-bindings-cosmosdb-v2-trigger?tabs=in-process%2Cextensionv4&pivots=programming-language-java)
			@HttpTrigger(
					name = "CDIHttpTrigger", 
